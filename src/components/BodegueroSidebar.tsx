import { Home, ArrowDownToLine, ArrowUpFromLine, LogOut, CircleMinus, } from "lucide-react";
import {
    Sidebar,
    SidebarContent,
    SidebarFooter,
...
export default function BodegueroSidebar() {
    const items = [
        ...
        },
        {
            ...
            url: "/bodeguero/IngresarProducto",
            icon: ArrowUpFromLine,
        },
        {
            title: "Salida producto",
            url: "/bodeguero/SalidaProducto",
            icon: ArrowDownToLine,
        },
        {
            title: "Registrar merma",
            url: "/bodeguero/RegistrarMerma",
            icon: CircleMinus,
        },
    ]
